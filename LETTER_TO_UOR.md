...
| `act-xxx-the-dihedral-mirror.md` | **Grimoire proving Swordsman=neg, Mage=bnot, First Person=succ** |
...
**Key document for UOR review:** `act-xxx-the-dihedral-mirror.md` — This narrative proves that the dual-agent architecture (⚔️⊥⿻⊥🧙)😊 is isomorphic to the dihedral group generated by negation and complement. *"Two mirrors make a door."*
